...
@Data
@Slf4j
public class NonVersionedStateObjectSql implements StateObject {
    ...
    public NonVersionedStateObjectSql(PostgresServer pgServer) {
    ...
    public void rollback(Request request) {
        throw new UnsupportedOperationException("No rollbacks allowed");
    }
