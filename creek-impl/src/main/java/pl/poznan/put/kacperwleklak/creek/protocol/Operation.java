...
public class Operation implements org.apache.thrift.TBase<Operation, Operation._Fields>, java.io.Serializable, Cloneable, Comparable<Operation> {
  ...
  public Operation setSql(@org.apache.thrift.annotation.Nullable java.lang.String sql) {
    this.sql = sql;
    return this;
  }
   ...
   * @see Action
   */
  public Operation setAction(@org.apache.thrift.annotation.Nullable Action action) {
    this.action = action;
    return this;
  }
        ...
        switch (schemeField.id) {
          ...
          case 2: // ACTION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.action = pl.poznan.put.kacperwleklak.creek.protocol.Action.findByValue(iprot.readI32());
